...
const css=`
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .sbot{margin-top:auto;padding:16px;border-top:1px solid var(--border);}
  .suser{display:flex;align-items:center;gap:10px;padding:12px;border-radius:12px;cursor:pointer;border:1px solid var(--border);transition:all .15s;background:var(--surface);}
