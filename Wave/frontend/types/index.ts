export interface User { name:string; email:string; id:number; initials:string; phone?:string; avatarUrl?:string; role?:string; kycStatus?:string;permissions?: Record<string, boolean>; totpEnabled?:boolean; }
